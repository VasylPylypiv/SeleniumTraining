...
def test_litecart_admin_login():
    ...
    main_page_price_color = ff.find_element_by_xpath("//strong[@class='campaign-price']").value_of_css_property('color')
    ...
    item_page_price_color = ff.find_element_by_xpath("//strong[@class='campaign-price']").value_of_css_property('color')
    item_page_font_weight = ff.find_element_by_xpath("//strong[@class='campaign-price']").value_of_css_property('font-weight')
    print(main_page_name == item_page_name)
    print(main_page_rprice == item_page_rprice)
    print(main_page_dprice == item_page_dprice)
    print(main_page_price_color == item_page_price_color)
    print(main_page_font_weight == item_page_font_weight)
    ff.quit()
